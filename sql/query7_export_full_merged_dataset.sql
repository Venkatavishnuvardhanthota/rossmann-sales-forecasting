...
-- Unlike Query 1 (filtered to Open=1, Sales>0, limited columns for a specific business question), this exports every row and every relevant column so Python can make its own filtering decisions (see Notebook 1, Cell 6).
